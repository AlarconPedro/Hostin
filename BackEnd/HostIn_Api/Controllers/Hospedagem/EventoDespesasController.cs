...
[ApiController]
public class EventoDespesasController : ControllerBase
{
    private readonly IEventoDespesasService _service;

    public EventoDespesasController(IEventoDespesasService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<ActionResult> Add(TbEventoDespesa evento)
    {
        if (evento == null)
        {
    ...
    [HttpPut]
    public async Task<ActionResult> Update(TbEventoDespesa evento)
    {
        if (evento == null)
        {
            return BadRequest("Evento cannot be null.");
